...
export const EditSubscriptionDialog = ({ open, onOpenChange, subscription, onSubscriptionUpdated }: EditSubscriptionDialogProps) => {
  ...
  useEffect(() => {
    if (subscription && open) {
      ...
      try {
        setNextPaymentDate(subscription.next_payment_date ? parseISO(subscription.next_payment_date) : undefined);
      } catch {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update details for this subscription
          </DialogDescription>
        </DialogHeader>
